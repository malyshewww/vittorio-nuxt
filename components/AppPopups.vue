<template lang="pug">
	...
	AppPopupNotice(:is-open="popupStore.popupNotice.isOpen" @close-popup="closePopupNotice" :popup-key="popupStore.popupNotice")
	...
	AppPopupSubscribe(:is-open="popupStore.popupSubscribe.isOpen" @close-popup="closePopupSubscribe" :popup-key="popupStore.popupSubscribe")
</template>
